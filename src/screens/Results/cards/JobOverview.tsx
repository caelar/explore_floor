...
// The large standalone job page, opened from the rail's "Job overview →" CTA. Three tabs — job
// overview, skills and competencies, how you fit — with per-job copy from jobs.ts and role-level
// stats from roleDetails. Its own control bar carries the Set-target pill + a close control that
// returns to the compact job rail.

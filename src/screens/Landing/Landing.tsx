    ...
    <main className="relative flex flex-1 flex-col overflow-hidden">
      ...
      >
        ...
        <button
          ...
          className="inline-flex h-control-lg cursor-pointer items-center justify-center rounded-full bg-arm-gold px-space-4 font-body text-body font-medium text-near-black transition-colors hover:bg-arm-gold-soft"
        >
          {landingCopy.cta}
        </button>
        <button

...
- **Awaiting Caelan:** the robotics_career commits/pushes (Pass-5 + its D-007 + the new `.design-sync/`), the career_dashboard archive tags/branch deletion, and the dashboard's stale FIGMA_MAP §4 totals line (81 → 105, a dashboard-session fix). An eyeball pass on the Interest Quiz file: https://www.figma.com/design/pjgrRJS5YYII1iciW7Pak2

...
> Context for the plan: this feeds Phase F of `docs/knowledge/archive/VISUAL_REARCHITECTURE.md`. Phases A–E don't depend on it, so there's runway, but the sooner this comes back, the better.
